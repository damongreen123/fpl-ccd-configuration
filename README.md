...
```$bash
DM_STORE_URL="http://dm-store-aat.service.core-compute-aat.internal" URL="https://manage-case.aat.platform.hmcts.net" IDAM_API_URL="https://idam-api.aat.platform.hmcts.net" CASE_SERVICE_URL="http://fpl-case-service-aat.service.core-compute-aat.internal" SHOW_BROWSER_WINDOW=true yarn test -g "Manage documents"
```
